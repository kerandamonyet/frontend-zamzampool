...
export default function SuccessPaymentPage() {
  ...
  return (
    <div className="mt-0 flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6 space-y-4">
          <div className="flex justify-between">
            <p className="text-gray-500 dark:text-gray-400 mt-2">
              Terima Kasih atas pembayaran nya, 
              <span className="font-bold text-black"> ID Pesanan</span> dapat dilihat pada email. Silahkan masukan{" "}
